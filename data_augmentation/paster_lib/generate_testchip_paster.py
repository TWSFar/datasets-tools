...
hyp = {
    ...
    'img_type': '.jpg',
    "coco": [0, 1, 3],
    "mask_json": "G:\\CV\\Dataset\\Detection\\Visdrone\\TEMP\\instances_mask_cascade_test_chip.json",
    'data_dir': 'G:\\CV\\Dataset\\Detection\\Visdrone\\TEMP\\challenge',
}
hyp['img_dir'] = osp.join(hyp['data_dir'], 'density_chip')
hyp['result_dir'] = osp.join(hyp['data_dir'], 'paster_pool_testchip')
